//============================================================================
// Name        : 154_DisplayYoungestStudentInMainUseStructAndFunction.c
// Author      :
// Version     :
...
//				 output the youngest student in the main program.
...
struct studinfo minAge(int n, struct studinfo p[]) {
